...
/*
    ...
    console.log(eitherStringIncluded("The mountain has a fountain","mountain","fountain"))
    console.log(eitherStringIncluded("The mountain has a fountain","mountain","bob"))
    console.log(eitherStringIncluded("The mountain has a fountain","meow","bob"))
...
console.log(fiveAndEleven(11))
console.log(fiveAndEleven(110))
...
/*
    ...
    console.log(countVowels("Chihuahua"))
...
console.log(alternatingLetters("Banana Bananana Banananana"))
